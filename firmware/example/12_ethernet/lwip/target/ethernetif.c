...
extern ETH_DMADescTypeDef  DMARxDscrTab[ETH_RX_DESC_CNT]; /* Ethernet Rx DMA Descriptors */ // @@ extern 붙히기
extern ETH_DMADescTypeDef  DMATxDscrTab[ETH_TX_DESC_CNT]; /* Ethernet Tx DMA Descriptors */ // @@ extern 붙히기
...
// @@
extern ETH_HandleTypeDef heth; // MX_ETH내 handler명은 heth입니다. 이부분을 바꿔주세요. (이렇게 해야 편합니다.) // @@ extern 붙히기
extern ETH_TxPacketConfig TxConfig; // @@ extern 붙히기
...
//
//   GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_7|GPIO_PIN_5;
//   GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
//   GPIO_InitStruct.Pull = GPIO_NOPULL;
//   GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
//   GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
void ethernet_link_check_state(struct netif *netif)
{
  ...
  {
    // @@ 핸들러 이름이 다르고, 또한 폴링 방식을 쓰지 않을 예정이니 인터럽트로 바꿔 줄겁니다.
  ...
  else if(!netif_is_link_up(netif) && (PHYLinkState > LAN8742_STATUS_LINK_DOWN))
  {
    ...
    {
      /* Get MAC Config MAC */
      HAL_ETH_GetMACConfig(&heth, &MACConf); // @@ 핸들러 이름 전부 heth로 통일
